    ...
    <table border='1'>
        ...
        <?php
            ...
            <tr>
                ...
                <td aling="center"> <a href="ver_imagens.php?id=<?php echo $arquivos['codigo'];?>"> Ver imagem </a href></td>  
                <td aling="center"><a href="excluir_imagens.php?id=<?php echo $arquivos['codigo'];?>"> Excluir </a href></td>
            </tr>
        <?php } ?>
    </table>
</body>
